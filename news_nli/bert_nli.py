...
class BertNLIModel(nn.Module):
    ...
    """
    def __init__(self,model_path=None,gpu=True,bert_type='bert-large',label_num=2,batch_size=8,reinit_num=0,freeze_layers=False):
    ...
    @staticmethod
    def load(input_path,gpu=True,bert_type='base',label_num=2,batch_size=16):
        if gpu:
